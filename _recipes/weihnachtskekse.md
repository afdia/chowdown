...
images:
  ...
  - image: ../images/weihnachtskekse_mandel.webp
    description: Variante mit 200g Dinkel-VK und 100g geriebene Mandeln schmeckt super, die Mandeln schmecken nur dezent hervor, Teig ist evtl etwas brüchiger. Kekse im Eck vom Blech sind aber zu dunkel geworden (evtl wegen altem Backrohr?)
  - image: ../images/weihnachtskekse_linzeraugen.webp
    description: Linzeraugen kann man damit auch machen indem man mit einer kleineren Form innerhalb ein Lock reinmacht (nebenbei hat man so paar kleine Kekse). Schmeckt auch sehr gut aber wenn man sie in eine Box mit anderen Keksen gibt, werden die anderen Kekse zu weich, also besser separat aufbewahren

ingredients:
- 300g Dinkel-Vollkornmehl
- 75g Staubzucker (inkl. 1 Packung Vanillezucker)
- 150g Butter (kalt!) (war früher nur 140g)
- 1/2 Pkg Backpulver
- 1 Ei
